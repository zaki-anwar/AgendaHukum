...
if (isset($_GET['id_perkara'])) {
  ...
  if ($result->num_rows == 0) {
    $_SESSION['message'] = "Perkara tidak ditemukan.";
    $_SESSION['message_type'] = "danger";
    header("Location: ../../user_admin/perkara.php");
    exit();
  }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($stmt->execute()) {
  $_SESSION['message'] = "Perkara berhasil diperbarui.";
  $_SESSION['message_type'] = "success";
  $_SESSION['message_section'] = "perkara"; //  Tambahkan ini
  header("Location: ../../user_admin/perkara.php");
  exit();
} else {
  $_SESSION['message'] = "Terjadi kesalahan saat memperbarui perkara.";
  $_SESSION['message_type'] = "danger";
  $_SESSION['message_section'] = "perkara"; //  Tambahkan ini juga
  header("Location: edit_perkara.php?id_perkara=" . $id_perkara);
  exit();
}
