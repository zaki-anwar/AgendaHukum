    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <?php
            if (
                isset($_SESSION['message'], $_SESSION['message_type'], $_SESSION['message_section']) &&
                in_array($_SESSION['message_section'], ['perkara', 'data_perkara'])
            ) {
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center pb-2 fs-4">Daftar Perkara</h5>
              <p><a href="../crud/perkara/tambah_perkara.php" class="btn btn-primary">Tambah Perkara</a></p>
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  if (mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                                <a href='../crud/perkara/edit_perkara.php?id_perkara=" . $row['id_perkara'] . "' class='text-primary me-3'>
                                  <i class='bi bi-pencil-square'></i></a>
                                <a href='../crud/perkara/hapus_perkara.php?hapus=" . $row['id_perkara'] . "' class='text-danger' onclick='return confirm(\"Apakah Anda yakin ingin menghapus perkara ini?\")'>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center pb-2 fs-4">Daftar Data Perkara</h5>
              <?php
                $query_check = "SELECT COUNT(*) AS jumlah FROM perkara";
                $result_check = mysqli_query($conn, $query_check);
                $row_check = mysqli_fetch_assoc($result_check);
                  if ($row_check['jumlah'] > 0) {
                    echo '<p><a href="../crud/data_perkara/tambah_dataperkara.php" class="btn btn-primary">Tambah Data</a></p>';
                  } else {
              ...
              <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (isset($row['id_data']) && !empty($row['id_data'])) {
                      echo "<a href='../crud/data_perkara/edit_dataperkara.php?id_data=" . urlencode($row['id_data']) . "' class='text-primary me-3'>
                              <i class='bi bi-pencil-square'></i>
                            </a>";
                      echo "<a href='../crud/data_perkara/hapus_dataperkara.php?id_data=" . urlencode($row['id_data']) . "' class='text-danger' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'>
